...
def main(filepath='/', window=3, truncate=None, columns=None):
    ...
    for test in range(3):
        ...
        obj = pd.DataFrame({
            'author': ['JW'] * 23,
            'trial': [test] * 23,
            'sensor_mode': [file_name.split('_')[4]] * 23,
            'sensor_location': [title_main.split('-')[2]] * 23,
            'metric_name': ['test', 'lvl', 'duration',
            ...
            'metric_description': ['test', 'level of severity', 'duration',
            ...
            'x': [title_main.split('-')[0], int(title_main.split('-')[1][-1]), df.loc[len(df)-1,'elapsed (s)']-df.loc[0,'elapsed (s)'],
            ...
            'y': [title_main.split('-')[0], int(title_main.split('-')[1][-1]), df.loc[len(df)-1,'elapsed (s)']-df.loc[0,'elapsed (s)'],
            ...
            'z': [title_main.split('-')[0], int(title_main.split('-')[1][-1]), df.loc[len(df)-1,'elapsed (s)']-df.loc[0,'elapsed (s)'],
            ...
            'resultant': [title_main.split('-')[0], int(title_main.split('-')[1][-1]), df.loc[len(df)-1,'elapsed (s)']-df.loc[0,'elapsed (s)'],
...
info = main(filepath=input('Please Insert File Name (without .csv): '), truncate=truncation.patient1, columns=cols)
