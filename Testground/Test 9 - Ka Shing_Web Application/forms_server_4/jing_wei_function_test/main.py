...
# MAIN FUNCTION
def main(df, filepath='/', window=3, truncate=None, columns=None):
# def main(df_main, file_name, title_main, window=3, truncate=None, columns=None):
    info = []
    filepath = '/'
...
def overall_main(json):
    info = main(json['accel_df'], json[], json['name'], json['saved_name'], truncate=truncation.values, columns=cols)
