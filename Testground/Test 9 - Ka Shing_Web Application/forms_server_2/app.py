...
def home():
    ...
    The Data Form Section is populated during the GET logic based on the uploaded files that have not been saved, i.e. they do not have dataframes.
    ...
    if request.method == "POST":
        ...
        if request.files:
            ...
            page.update_notification(' '.join([str(len(files)), ' files uploaded.']), success='success')
            ...
            page.update_notification(' '.join([str(validated_files), ' files matching permitted extensions.']), success=extension_check)
            ...
            if validated_files != 0:
                ...
                page.update_notification(' '.join([str(len(sessions)), ' sessions identified.']), success='success')
                ...
                page.update_notification(' '.join([str(validated_sessions), ' sessions matching desired sensor types.']), success=session_check)
